    ...
    public struct Appearance {
        ...
        public init(statusBarStyle: UIStatusBarStyle = .default,
            ...
            if var customAnnotationTextAttributes = annotationTextAttributes {
                ...
                if customAnnotationTextAttributes[NSAttributedString.Key.font] == nil {
                    customAnnotationTextAttributes[NSAttributedString.Key.font] = type(of: self).DefaultAnnotationTextFont
                }
...
private extension InterfaceCustomization.Appearance {
    ...
    static var defaultTextAnnotationAttributes: [NSAttributedString.Key: AnyObject] {
        ...
        return [NSAttributedString.Key.font: DefaultAnnotationTextFont,
                NSAttributedString.Key.shadow: shadow,
                NSAttributedString.Key.kern: 1.3 as NSNumber]
    }
